...
This is a non-divisible coin, pre-mined, written in C, compiled with GCC, 256-bit key length, Transactions are 77.6% smaller than an average Bitcoin-Core transaction, relating to total blockchain size.
