...
Join us on Telegram [@vfcash](https://t.me/vfcash) because it's better if you request from one of the existing node operators in the official telegram channel that they manually add your node's IPv4 address.
