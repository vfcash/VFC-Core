# VF Cash
VF Cash is the most efficient IoT Cryptocurrency project, at the current point in time it uses only 1.8 MB of memory, no proof of work (PoW) and blockchain file that grows at a rate 76% less than Bitcoin. [Whitepaper.pdf](https://github.com/vfcash/RELEASES/blob/master/vfcash.pdf)
